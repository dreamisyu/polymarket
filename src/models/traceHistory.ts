...
const executionSchema = new Schema<TraceExecutionInterface>(
    {
        ...
        traceLabel: { type: String, required: true },
        sourceWallet: { type: String, required: true },
        sourceActivityId: { type: Schema.Types.ObjectId, required: true },
        sourceTransactionHash: { type: String, required: true },
        sourceTimestamp: { type: Number, required: true },
        sourceSide: { type: String, required: true },
        executionCondition: { type: String, required: true },
        status: { type: String, enum: ['FILLED', 'SKIPPED'], required: true },
