...
const copyIntentBufferSchema = new Schema<CopyIntentBufferInterface>(
    {
        ...
        sourceUsdcTotal: { type: Number, required: false, default: 0 },
        ...
        bufferWindowMs: { type: Number, required: false, default: 0 },
        sizingMode: { type: String, required: false, default: 'ratio' },
...
const copyExecutionBatchSchema = new Schema<CopyExecutionBatchInterface>(
    {
        ...
        executionKind: { type: String, required: false, default: 'TRADE' },
        condition: { type: String, required: true, default: '' },
        asset: { type: String, required: true, default: '' },
        conditionId: { type: String, required: false, default: '' },
        title: { type: String, required: false, default: '' },
        ...
        completedAt: { type: Number, required: false, default: 0 },
        localPositionSizeBefore: { type: Number, required: false, default: 0 },
        localConditionMergeableSizeBefore: { type: Number, required: false, default: 0 },
        lastConfirmationSource: { type: String, required: false, default: '' },
        reason: { type: String, required: false, default: '' },
