...
export const createRpcProvider = (config: Pick<RuntimeConfig, 'rpcUrl'>) => new JsonRpcProvider(config.rpcUrl);
...
export const createWalletWriter = (
    config: Pick<RuntimeConfig, 'privateKey' | 'rpcUrl'>
) => {
